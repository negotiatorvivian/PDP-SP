...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--random_seed', help='Random seed', type=int, default=0)
    ...
    if args['dimacs']:
        ...
        if os.path.isfile(args['test_path']):
            ...
            dimacs2json1.convert_file(args['test_path'], temp_file_name, False)
        else:
            temp_file_name = os.path.join(args['test_path'], temp_file_name)
            dimacs2json1.convert_directory(args['test_path'], temp_file_name, False)
